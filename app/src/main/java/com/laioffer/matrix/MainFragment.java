...
//    }
    ...
    public static void verifyStoragePermissions(Activity activity) {
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            //We don't have permission sp prompt the user
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if (locationTracker != null) {
            locationTracker.getLocation();
            distance = Utils.distanceBetweenTwoLocations(latitude, longitude, locationTracker.getLatitude(), locationTracker.getLongitude());
        }
    ...
    private void setupBottomBehavior() {
        ...
        mEventImageLike = view.findViewById(R.id.event_info_like_img);
        mEventImageComment = view.findViewById(R.id.event_info_comment_img);
        mEventImageType = view.findViewById(R.id.event_info_type_img);
        mEventTextLike = view.findViewById(R.id.event_info_like_text);
        mEventTextType = view.findViewById(R.id.event_info_type_text);
        mEventTextLocation = view.findViewById(R.id.event_info_location_text);
        mEventTextTime = view.findViewById(R.id.event_info_time_text);
    }
}
